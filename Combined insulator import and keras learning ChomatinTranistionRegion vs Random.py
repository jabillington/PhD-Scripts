# -*- coding: utf-8 -*-
"""
Created on Thu Nov  7 11:19:15 2019
...
sliced=sequence_extract.str.slice(start=000,stop=8000)
...
sliced=sequence_extract.str.slice(start=0,stop=8000)
...
one_hot_encoded=one_hot_encode(insulator_dataset,col='Sequence',seq_len=7999)
...
def train_model(x, y, nb_epoch, conv_layers=2, inp_len=7999, border_mode='same', nbr_filters=128, filter_len=8, 
